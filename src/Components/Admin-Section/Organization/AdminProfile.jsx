                ...
                <Form>
                  <Row className="gy-4">
                    <Col md={6}><Form.Label>Name Of the Company</Form.Label>
                      ...
                      <Form.Control as="textarea" name="responsibilities" value={experience.responsibilities} onChange={handleExperienceChange} placeholder="Describe your job responsibilities" className="pexform-input1" disabled={!isEditingExperience} />
                    </Col> 
                    <Col md={6}> 
                ...
                <Form>
                  <Row className="gy-4">
                    <Col md={6}><Form.Label>Bank Name</Form.Label>
                      <Form.Control type="text" name="bankName" value={bank.bankName} onChange={handleBankChange} placeholder="Name of the Bank"  disabled={!isEditingBank} /></Col>
                    <Col md={6}><Form.Label>Branch</Form.Label>
                      <Form.Control type="text" name="branch" value={bank.branch} onChange={handleBankChange} placeholder="Name of the Branch" disabled={!isEditingBank} /></Col>
                    <Col md={6}><Form.Label>Account Number</Form.Label>
                      <Form.Control type="text" name="accountNumber" value={bank.accountNumber} onChange={handleBankChange} placeholder="Bank AC Number" disabled={!isEditingBank} /></Col>
                    <Col md={6}><Form.Label>IFSC Code</Form.Label>
                      <Form.Control type="text" name="ifsc" value={bank.ifsc} onChange={handleBankChange} placeholder="IFSC Code" disabled={!isEditingBank} /></Col>
                    <Col md={6}><Form.Label>Aadhaar Number</Form.Label>
                      <Form.Control type="text" name="aadhaar" value={bank.aadhaar} onChange={handleBankChange} placeholder="XXXX-XXXX-XXXX" disabled={!isEditingBank} /></Col>
                    <Col md={6}><Form.Label>PAN Number</Form.Label>
                      <Form.Control type="text" name="pan" value={bank.pan} onChange={handleBankChange} placeholder="ABCDE1234F" disabled={!isEditingBank} /></Col>
                  </Row>
                </Form>
              </div>
            </Tab.Pane>
